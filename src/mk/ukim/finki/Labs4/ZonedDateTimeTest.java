...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        return ZonedDateTime.parse("2015-06-18T23:07:25+09:00").withZoneSameLocal(ZoneId.of("Asia/Tokyo"));
    }
    ...
    static ZonedDateTime sameInstantAs() {
         ...
         */
        return ZonedDateTime.ofInstant(zdt.toInstant(),ZoneId.of("America/Los_Angeles"));
    }
